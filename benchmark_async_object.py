...
async def main(n_requests=1000, concurrency=10, output_folder="./results/async",
    ...
    end_time = prometheusClient.get_current_time()+10
    ...
    sm_clock_query='DCGM_FI_DEV_SM_CLOCK{job="prometheus/dcgm-exporter", instance="10.244.3.95:9400", gpu="0"}'
...
if __name__ == '__main__':
    asyncio.run(main(n_requests=, concurrency=30, output_folder="./results/async/object",
