...
async def hiro(n_requests=1000, concurrency=10, output_folder="./results/async",
               prometheus_url="http://your_prometheus_server:9090",wait_time=20,service_url=""):
        results = benchmark_async_duration(n_requests, concurrency)
...
async def main(n_requests=1000, concurrency=10, output_folder="./results/async",
    ...
    step = "2s"  # 每 1 秒一個數據點
    gpu_util_query='DCGM_FI_DEV_GPU_UTIL{job="prometheus/dcgm-exporter", instance="10.244.2.87:9400", gpu="0"}'
    sm_clock_query='DCGM_FI_DEV_SM_CLOCK{job="prometheus/dcgm-exporter", instance="10.244.2.87:9400", gpu="0"}'
    ...
    gpu_mem_query='DCGM_FI_DEV_FB_USED{job="prometheus/dcgm-exporter", instance="10.244.2.87:9400", gpu="0"}'
    ...
    power_usage_query='DCGM_FI_DEV_POWER_USAGE{job="prometheus/dcgm-exporter", instance="10.244.2.87:9400", gpu="0"}'
    ...
    GPU_TEMP_query='DCGM_FI_DEV_GPU_TEMP{job="prometheus/dcgm-exporter", instance="10.244.2.87:9400", gpu="0"}'
...
if __name__ == '__main__':
    asyncio.run(main(n_requests=10, concurrency=10, output_folder="./results/async/pose",
                      prometheus_url="http://172.22.9.249:30000",wait_time=10))
