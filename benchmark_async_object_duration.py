...
from object.Async.object_client_async import get_stub, send_request
...
if __name__ == '__main__':
    asyncio.run(main(n_requests=20, concurrency=10, output_folder="./results/async/object",
                      prometheus_url="http://172.22.9.249:30000",wait_time=40))
